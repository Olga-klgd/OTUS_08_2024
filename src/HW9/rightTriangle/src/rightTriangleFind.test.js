...
describe("rightTriangleFind", () => {
  ...
  [
    { a: 3, b: 4, c: 5, answerResult: "квадратный" },
    { a: 1, b: 2, c: 2, answerResult: "не квадратный" },
    { a: 10, b: 20, c: 2, answerResult: "не квадратный" },
  ].forEach(({ a, b, c, answerResult }) => {
    it(`Для сторон ${a}, ${b}, ${c} - ${answerResult}'`, () => {
      let answer = rightTriangleFind(a, b, c);
